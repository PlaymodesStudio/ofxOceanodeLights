...
void oscSenders::setup(){
    ...
    addParameter(tilt.set("Tilt In", {0}, {-180}, {180}));
    
    colors.resize(4);
    addParameter(colors[0].set("Heads Color", {1}, {0}, {1}));
    
    addParameter(colors[1].set("Wash Color", {1}, {0}, {1}));
    
    addParameter(colors[2].set("ParL Color", {1}, {0}, {1}));
    addParameter(colors[3].set("ParR Color", {1}, {0}, {1}));
